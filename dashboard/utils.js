...
const PAGE_TITLES = {
  ...
  analytics: { title: 'System Analytics', breadcrumb: 'Real-time telemetry and resource usage' },
  swarm: { title: 'Swarm Orchestration', breadcrumb: 'Real-time multi-agent activity' },
  workspace: { title: 'Workspace', breadcrumb: 'AI outputs and artifacts' },
